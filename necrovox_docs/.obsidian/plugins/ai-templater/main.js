  ...
  constructor(plugin) {
    ...
    this.chat = async (promptOrMessages, model, systemMessage, maxTokens, maxOutgoingCharacters, baseURL, apiKey, organization) => {
      ...
      if (!this.validateSettings()) {
        new import_obsidian.Notice("Check your setting for valid API key, model and endpoint.", 1e4);
        return "";
      }
      ...
      try {
        const completion = await openai.chat.completions.create({
          ...
          max_tokens: maxTokens != null ? maxTokens : this.plugin.settings.defaultMaxNumTokens
        });
        ...
        if (((_a2 = import_obsidian.Platform.isDesktop && this.plugin.settings.displayTokenUsageDesktop) != null ? _a2 : false) || ((_b = import_obsidian.Platform.isMobile && this.plugin.settings.displayTokenUsageMobile) != null ? _b : false)) {
...
Character count: ${characterCount.toString()}`;
        ...
        new import_obsidian.Notice(`${this.plugin.APP_ABBREVIARTION} Error: ` + String(error), 2e4);
        return "";
      }
    };
    ...
    this.availableModels = async () => {
      ...
      if (!this.validateSettings()) {
        new import_obsidian.Notice(`${this.plugin.APP_ABBREVIARTION} Check your setting for valid API key, model and endpoint.`, 1e4);
        return [];
      }
...
var OWlSettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("System message").setDesc(`Default system message sent with each prompt. This message is used to initialize the conversation.`).setClass("ait-settings").addTextArea((textEl) => {
    ...
    new import_obsidian2.Setting(containerEl).setName(`Debug to the console`).setDesc(`Dumps detailed into to the console for debugging.`).addToggle((cb) => {
      var _a2;
      cb.setValue((_a2 = this.plugin.settings.debugToConsole) != null ? _a2 : false);
    ...
    new import_obsidian2.Setting(containerEl).setName(`Display token usage on desktop`).setDesc(
      ...
      var _a2;
      cb.setValue((_a2 = this.plugin.settings.displayTokenUsageDesktop) != null ? _a2 : false);
      cb.onChange(async (value) => {
        this.plugin.settings.displayTokenUsageDesktop = value;
        await this.plugin.saveSettings();
      });
    });
    new import_obsidian2.Setting(containerEl).setName(`Display token usage on mobile`).setDesc(`Displays the  number of tokens used a notification on the mobile.`).addToggle((cb) => {
      var _a2;
      cb.setValue((_a2 = this.plugin.settings.displayTokenUsageMobile) != null ? _a2 : false);
      cb.onChange(async (value) => {
...
var ActivityIndicator = class {
  ...
  add() {
    ...
    bounceDelays.forEach((delay) => {
      ...
      (_a2 = this.spinner) == null ? void 0 : _a2.appendChild(bounce);
    });
    const activeViewHeader = document.querySelector(".workspace-leaf.mod-active .cm-scroller");
    if (activeViewHeader)
      activeViewHeader.after(this.spinner);
...
var InternalModuleAit = class extends InternalModule {
  ...
  generate_selection_or_nearest() {
    return () => {
      var _a2;
      const active_editor = (_a2 = this.plugin) == null ? void 0 : _a2.app.workspace.activeEditor;
  ...
  async generate_content_without_properties() {
    ...
    if (this.config.target_file instanceof import_obsidian3.TFile) {
      ...
      const fileContents = await ((_a2 = this.plugin) == null ? void 0 : _a2.app.vault.read(file));
  ...
  generate_run_chat() {
    return async (promptOrMessages, model, systemMessage, maxTokens, maxOutgoingCharacters, baseURL, apiKey, organization) => {
      ...
      spinner.add();
      try {
        const result = (_b = await ((_a2 = this.plugin) == null ? void 0 : _a2.openAiApi.chat(
          promptOrMessages,
          model,
          systemMessage,
          maxTokens,
    ...
    around(plugin.app.plugins, {
      enablePlugin(oldMethod) {
        return async function(pluginId) {
          if (pluginId === "templater-obsidian") {
            setTimeout(async () => {
              var _a2;
              if ((_a2 = window.ait) == null ? void 0 : _a2.plugin)
      ...
      disablePlugin(oldMethod) {
        return async function(pluginId) {
          ...
          if (pluginId === "templater-obsidian") {
            if ((_a2 = window.ait) == null ? void 0 : _a2.plugin)
              window.ait.plugin.internalModuleAit = null;
          }
          return oldMethod.call(this, pluginId);
        };
      }
